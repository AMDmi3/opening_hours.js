...
test.addTest('Variable days: school holidays', [
	...
	], 1000 * 60 * 60 * 24 * (3 + 11 + 11 + 1 + 31 + 12 + 3 + 14), 0, false, nominatiomTestJSON, 'not last test');
...
test.addTest('Variable days: school holidays', [
		'SH',
            ...
            [ '2014.01.30 00:00', '2014.01.31 00:00' ],
            [ '2014.04.03 00:00', '2014.04.22 00:00' ],
            [ '2014.05.30 00:00', '2014.05.31 00:00' ],
            [ '2014.06.10 00:00', '2014.06.11 00:00' ],
            [ '2014.07.31 00:00', '2014.09.10 00:00' ],
            [ '2014.10.27 00:00', '2014.11.08 00:00' ],
            [ '2014.12.22 00:00', '2015.01.05 00:00' ],
	], 1000 * 60 * 60 * 24 * (3 + 11 + 11 + 1 + 31 + 12 + 3 + 14), 0, false, nominatiomTestJSON_bremen, 'not last test');

test.addTest('Variable days: school holidays', [
		'SH,PH',
	], '2014.01.01 0:00', '2014.02.15 0:00', [
            [ '2014.01.01 00:00', '2014.01.04 00:00' ], // SH including one public holiday
            [ '2014.01.06 00:00', '2014.01.07 00:00' ], // PH
	], 1000 * 60 * 60 * 24 * (3 + 1), 0, false, nominatiomTestJSON, 'last test');
...
test.addTest('Month weekday', [
		...
		[ '2012.01.01 00:00', '2012.03.01 00:00' ],
		[ '2012.11.01 00:00', '2013.01.01 00:00' ],
	], 1000 * 60 * 60 * 24 * (31 + 29 + 30 + 31), 0, false, {}, 'last test');
