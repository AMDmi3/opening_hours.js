...
var resources = { // English is fallback language.
    ...
    hu: {
        translation: {
            ...
            "texts": {
                "filter": {
                    "none": "Ne alkalmazzon semmilyen szűrőt",
                    "error": "Hibák és figyelmeztető üzenetek",
                    ...
                    "openOrUnknown": "Csak azok a létesítmények, amelyek most nyitva vannak vagy nem ismert a nyitvatartás",
                },
                "title": "opening_hours kiértékelő eszköz",
                ...
                "will close": "de <a href=\"__href__\">bezár</a> __timestring____comment__.",
                "will unknown": "de <a href=\"__href__\">kinyithat</a> __timestring____comment__.",
                "will open": "de <a href=\"__href__\">kinyit</a> __timestring____comment__.",
                "depends on": ", de ettől függően: __comment__.",
                "week stable": "Az időbeosztás bármely megadott héten érvényes.",
                "not week stable": "Figyelem! Ez az időbeosztás változhat más heteken.",
                "value for": "érték ehhez:",
                "value to compare": "összehasonlítandó érték az első értékhez képest",
                "MatchingRule": "Alkalmazott szabály",
                "prettified value": 'szépített opening_hours érték (ez az érték biztonságosan használható az OSM-ben, miután az összes figyelmeztetés <a href="__copyFunc__">meg lett oldva</a>)',
                "prettified value for displaying": "szépített opening_hours érték a megjelenítéshez (sortöréseket tartalmaz, ne használja ezt OSM értékként)",
                "more information": "További információkért nézze meg az <a __href__>OSM wiki</a> cikkeit.",
                "this website": "Ez a weboldal és a nyitvatartás kiértékeléséhez használt JavaScript programkönyvtár fejlesztése a <a href=\"__url__\" target=\"_blank\">__hoster__</a> projektben történik.",
                "if PH is between Mo and Fr": "Csak akkor, ha a nemzeti ünnep hétköznap (Mo-Fr)",
                "check out error correction, prettify": "nézze meg a hibajavítást és a szépített függvényt az opening_hours értéknél",
                "SH,PH or PH,SH": "Ez egy kis különbséget jelent az előző értékhez képest. Az iskolaszünet neve felülbírálja a PH neveket a megjegyzésben.",
                "config POIs": "POI-k beállítása",
                "reload map": "térkép újratöltése",
                "heading map": "Térkép az OpenStreetMap alapú opening_hours címke rétegével",
                ...
                "error": "Az értéket nem sikerült feldolgozni",
                "warning": "Ha figyelmeztetések jelentek meg a kiértékelés közben, akkor egy kék __sign__ jelenik meg az állapotikonban.",
                "map filter": "Van néhány szűrő, amely alkalmazható a hibák megtalálásához és kijavításához (minőségbiztosítás), vagy csak egyszerűen a nyitva lévő vagy bezárt létesítmények megjelenítéséhez:",
                "data source": 'A rátétadatok az __OSMStartaTag__ adatbázisából érkeznek, és az __APIaTag__ használatával vannak lekérdezve. A térkép szerzői joga: __OSMaTag__.',
                "mode 0": 'Csak időtartományok fogadhatók el (opening_hours, lit címkék)',
                "mode 1": 'Csak időpontok fogadhatók el',
                "mode 2": 'Időtartományok és időpontok is elfogadhatók (service_times, collection_times címkék)',
                "value to long for osm": 'Az érték túl hosszú az OSM számára. Az OpenStreetMap adatbázisa jelenleg korlátozva van a legfeljebb __maxLength__ karakter hosszúságú értékekre. A szépített érték __pretLength__ hosszúságú, és a beírt érték __valLength__ karakteres.',
                "low zoom level": 'A POI-k ${next} és magasabb nagyítási szinteken kezdenek megjelenni. Az Ön jelenlegi nagyítási szintje ${actual}.',
                "all n entries": 'Az összes __total__ bejegyzés:',
                "the first entries": 'Az első __number__ / __total__ bejegyzés:',
                "load all with JOSM": 'összes betöltése JOSM-ban',
                "evaluation tool": 'kiértékelő eszköz',
                "rule separator ;": 'szabályelválasztó (a következő szabály egy normál szabály lesz)',
                "rule separator  ||": 'szabályelválasztó (a következő szabály egy tartalék szabály lesz, amelyet minden olyan időnél alkalmaz, amit nem kezelnek az előző szabályok)',
                "rule separator ,": 'szabályelválasztó (a következő szabály egy kiegészítő szabály lesz, amely kiterjeszti az előző szabályok idejeit, és nem bírálja felül azokat, mint ahogy a normál szabályok tennék)',
                "JOSM remote conn error": 'Nem sikerült kapcsolódni a JOSM-hez. Győződjön meg arról, hogy a JOSM fut-e, és be van-e állítva az alapértelmezett 8111-es TCP porton keresztüli távoli vezérléshez.',
                "refer to yohours": 'Ezt az értéket a YoHours is fel tudná dolgozni, amely egy egyszerű szerkesztő az opening_hours szintaxisához. Ha nincs szüksége a szintaxis speciális funkcióira, akkor <a href=\"__href__\">próbálja ki</a>.',
                "include timestamp?": 'tartalmazzon időbélyeget?',
            },
            "words": {
                "modifier": "__name__ módosító",
                "selector": "__name__ kiválasztó",
